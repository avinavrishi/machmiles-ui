...
export const FlightDetails = ({ data }) => {
    ...
    return (
        <>
            ...
            <Grid container spacing={1} mb={2} padding={'0.5rem'}>
                <Grid item xs={0.75} display={'flex'} alignItems={'flex-start'} marginTop={'-1rem'}>
                    <img src={data?.carrier_image} width={'100%'} alt="logo" />
                </Grid>
                <Grid item xs={11.25} mb={2} display={'flex'} alignItems={'flex-start'} justifyContent={'flex-start'} textAlign={'left'} >
